...
class DownloadUtils {
  ...
  static Future<bool> downloadImg(String imgUrl, {String imgType = 'cover'}) async {
    try {
      ...
      String picName =
          "bibi${imgType}_${DateTime.now().toString().replaceAll(RegExp(r'[- :]'), '').split('.').first}";
      final SaveResult result = await SaverGallery.saveImage(
        Uint8List.fromList(response.data),
        name: '$picName.$imgSuffix',
        // 保存到 PiliPala文件夹
        androidRelativePath: "Pictures/BiliBala",
