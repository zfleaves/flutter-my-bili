...
class PlayOrPauseButton extends StatefulWidget {
  ...
  const PlayOrPauseButton(
      {super.key, this.iconSize, this.iconColor, this.controller});

  @override
  State<PlayOrPauseButton> createState() => _PlayOrPauseButtonState();
}

class _PlayOrPauseButtonState extends State<PlayOrPauseButton> with SingleTickerProviderStateMixin {
