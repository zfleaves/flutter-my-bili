...
import 'package:bilibili/pages/search/controller.dart';
import 'package:bilibili/pages/search/widgets/hot_keyword.dart';
                    ...
                    return CustomScrollView(
                      slivers: [
                        HttpError(
                          errMsg: data['msg'],
                          fn: () => setState(() {
                            _futureBuilderFuture = ctr.queryHotSearchList();
                          }),
                        )
                      ],
                    );
