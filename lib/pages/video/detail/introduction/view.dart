...
import 'package:bilibili/pages/video/detail/introduction/widgets/intro_detail.dart';
import 'package:bilibili/pages/video/detail/introduction/widgets/page_panel.dart';
import 'package:bilibili/pages/video/detail/introduction/widgets/season_panel.dart';
import 'package:bilibili/pages/video/detail/introduction/widgets/staff_up_item.dart';
import 'package:bilibili/pages/video/detail/widgets/ai_detail.dart';
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return HttpError(
            ...
            btnText:
                snapshot.data['code'] == -404 || snapshot.data['code'] == 62002
                    ? '返回上一页'
                    : null,
            fn: () => Get.back(),
          );
...
class VideoInfo extends StatefulWidget {
  ...
  final String bvid;
  const VideoInfo(
      {super.key, this.videoDetail, this.heroTag, required this.bvid});
...
class _VideoInfoState extends State<VideoInfo> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scaleTransition = Tween<double>(begin: 0.5, end: 1.0).animate(_controller)
      ..addListener(() async {
        _progress.value =
  ...
  onPushMember() {
    ...
    Get.toNamed('/member?mid=$mid', arguments: {
      ...
      'uname': widget.videoDetail!.owner!.name
    });
  }
