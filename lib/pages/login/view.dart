      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: '浏览器打开',
            onPressed: () {
              Get.offNamed('/webview', parameters: {
      ...
      body: PageView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Obx(() => _loginPageCtr.loginType.value == 0
                ? Form(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () => _loginPageCtr.changeLoginType(),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Stack(
                            children: [
                              TextFormField(
                                controller: _loginPageCtr.msgCodeTextController,
                                ...
                                onSaved: (val) =>
                                    _loginPageCtr.webSmsCode = int.parse(val!),
                              ),
                              Obx(() {
                                return Positioned(
                                  right: 8,
