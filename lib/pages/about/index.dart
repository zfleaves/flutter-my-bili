...
import 'package:bilibili/utils/cache_manage.dart';
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              trailing: Text(
                'github.com/zfleaves/flutter-my-bili',
                style: subTitleStyle,
              ),
            ),
            ListTile(
...
class AboutController extends GetxController {
  ...
  githubUrl() {
    launchUrl(
      Uri.parse('https://github.com/zfleaves/flutter-my-bili'),
  ...
  githubRelease() {
    launchUrl(
      Uri.parse('https://github.com/zfleaves/pilipala/flutter-my-bili'),
      mode: LaunchMode.externalApplication,
    );
  }
